...
Interfaces: `BinaryOperator`, `ColumnFoldable`, `ConditionallySpeculatable`, `InferTypeOpInterface`, `NoMemoryEffect (MemoryEffectOpInterface)`, `NullColumnTypeChangeable`, `Operator`, `PredicateOperator`, `TupleLambdaOperator`
...
Interfaces: `ColumnFoldable`, `ConditionallySpeculatable`, `InferTypeOpInterface`, `NoMemoryEffect (MemoryEffectOpInterface)`, `NullColumnTypeChangeable`, `Operator`, `TupleLambdaOperator`, `UnaryOperator`
...
Interfaces: `ColumnFoldable`, `ConditionallySpeculatable`, `InferTypeOpInterface`, `NoMemoryEffect (MemoryEffectOpInterface)`, `NullColumnTypeChangeable`, `Operator`, `PredicateOperator`, `TupleLambdaOperator`, `UnaryOperator`
