...
| `length` | length of string in characters | `length('hello')` | `5` |
| `abs` | absolute value of number        | `abs(-1.5)` | `1.5` |
| `upper` | transform string to upper case        | `upper('abc'::string)` | `"ABC"` |
| `round` | round number to number of digits       | `round(1.0006,3)` | `1.0010` |
| `regexp_replace` | replace regex matches in a string | `regexp_replace('hello world','o','0')` | `"hell0 w0rld"` |
